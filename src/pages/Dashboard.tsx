...
import { Wallet, TrendingUp, TrendingDown, HandCoins, Landmark, Settings, Coffee, Sun, Moon } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <a href="https://buymeachai.in/arghya" target="_blank" rel="noopener noreferrer" aria-label="Buy me a chai">
            <Button
              variant="ghost"
              size="icon"
